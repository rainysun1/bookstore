...
onclick='fillNameValue(this)' onmouseover='changeBackground_over(this)' 
...
<div id="divsearch">
	<form action="${pageContext.request.contextPath}/findProductBySearch"
		...
		<table width="100%" border="0" cellspacing="0">
			<tr>
			<td style="text-align:left;padding-left:220px"><a 

href="index.jsp"><img src="images/logo.png " alt="logo" width=100px;heigth=50px;></a> </td>

				<td style="text-align:right;padding-top:40px;padding-right:220px">
				Search <input
					type="text" name="name" value="" 

class="inputtable" onkeyup="searchName();"
					id="name" /> 
					<input type="image" 

src="images/serchbutton.gif"
...
<div id="divmenu">
	<a
		href="${pageContext.request.contextPath}/showProductByPage?category=
